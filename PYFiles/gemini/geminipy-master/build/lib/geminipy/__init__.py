...
class Geminipy(object):
    ...
    def book(self, symbol='ethbtc', limit_bids=0, limit_asks=0):
        """
    ...
    def trades(self, symbol='ethbtc', since=0, limit_trades=50,
               include_breaks=0):
        """
    ...
    def new_order(self, amount, price, side, client_order_id=None,
                  symbol='ethbtc', type='exchange limit'):
        """
    ...
    def past_trades(self, symbol='ethbtc', limit_trades=50, timestamp=0):
        """
